...
(function () {
    ...
    g.RTCConnectionState = RTCConnectionState;

    // RTCConnectionRole
    var RTCConnectionRole = {
        CONTROLLING: "controlling",
        CONTROLLED: "controlled"
    };

    g.RTCConnectionRole = RTCConnectionRole;
    ...
    // RTCConnectionInfo
    function RTCConnectionInfo(ice, dtls) {
        return {
            ice: ice,
            dtls: dtls
        };
    ...
    g.RTCConnectionInfo = RTCConnectionInfo;

    // RTCIceCandidateInfo 
    function RTCIceCandidateInfo(fdn, comp, trp, pri, cA, cP, typ, relA, relP) {
        return {
            foundation: fdn,
            component: comp,
            transport: trp,
    ...
    g.RTCIceCandidateInfo = RTCIceCandidateInfo;
